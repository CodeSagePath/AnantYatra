  ...
  return (
    <div className="w-full max-w-md p-8 rounded-3xl bg-white dark:bg-midnight-2 border border-slate-200 dark:border-white/10 shadow-2xl">
      <div className="flex flex-col items-center mb-8">
        ...
        <h2 className="text-2xl font-extrabold text-slate-900 dark:text-porcelain tracking-tight">Welcome to AnantYatra</h2>
        <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm font-medium">Sign in to plan infinite journeys</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => alert("Password reset functionality will be sent to your email. (Dummy)")}
              className="text-xs font-semibold text-evergreen hover:text-evergreen/80 dark:text-grapefruit dark:hover:text-grapefruit/80"
            >
              Forgot Password?
            </button>
          </div>
